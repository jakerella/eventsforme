    ...
    */
    ...
    sendToClient: function(targetClientId, payload, callbackFunction, scope) {
        if(payload && typeof(payload) === "object") {
            ...
            this.send({service: "CourierService", msg: payload}, callbackFunction, scope);
        } else {
    ...
    send: function(envelope, callbackFunction, scope) {
        ...
        // service version
        envelope.sv = Ext.cf.util.ServiceVersionHelper.get(envelope.service);
    ...
    subscribe: function(serviceName, callbackFunction, scope) {
        ...
        var params = { 
            ...
            service: serviceName,
            sv: Ext.cf.util.ServiceVersionHelper.get(serviceName)
        };
