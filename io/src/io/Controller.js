 ...
 * @class Ext.io.Controller
 ...
 For details on how to use Channels see [How to use Application Controller](#!/guide/concepts_controller)
 *
 *
 *
 */
    ...
    "Ext.io.ux.ChangePassword"
        ...
        */
        auth: function() {
            ...
            var launch = this.getLaunchComplete();
            var adfasf = this.getIoInitComplete();
